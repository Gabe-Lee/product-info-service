...
const LastPackage = ({ pAssembly, pAvaliableForDelivery, displayDeliveryDrawer }) => (

  <div className="b_lastPackage">
    {pAvaliableForDelivery === 1
      ? (
        <div className="b_deliveryBox">
          <div className="b_deliveryHeader">
            <button type="button" aria-expanded="false" className="b_deliveryButton" onClick={displayDeliveryDrawer}>
              <div className="b_deliveryItems">
                <span className="b_deliveryLogos">
                  ...
                  <img className="b_deliveryGreenDot" alt="" src="https://www.ikea.com/us/en/resources/svg/product-availability/stock-high-thin-24.50443bcac2b4be21.svg" />
                </span>
    ...
    <div className="b_findStoreBox">
      <div className="b_findStoreHeader">
        <div className="b_findStoreItems">
          ...
          <div className="b_Links">Check at your local store</div>
        </div>
      </div>
    </div>
...
LastPackage.propTypes = {
  pAssembly: T.number.isRequired,
  pAvaliableForDelivery: T.number.isRequired,
  displayDeliveryDrawer: T.func.isRequired,
};
